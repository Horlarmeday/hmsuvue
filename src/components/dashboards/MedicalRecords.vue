            ...
            <div class="kt-widget24">
              <div class="kt-widget24__details">
                <div class="kt-widget24__info">
                  ...
                  <span class="kt-widget24__desc">
                    Total number of medical records personnel
                  </span>
                </div>
                  ...
                  <tr v-for="(patient, index) in patients" :key="patient._id">
                    ...
                    <td>
                      <router-link v-if="patient.creator" to="#">
                        ...
                        {{ patient.creator.lastname }}
                      </router-link>
                      <p v-else>None</p>
                    </td>
                    <td>
                      {{ patient.createdAt | moment('DD/MM/YYYY, h:mm:ss') }}
                    </td>
...
export default {
  ...
  methods: {
    ...
    dashboard() {
      axios
        ...
        .then(response => {
          ...
          this.medicalrecordsCount = response.data.data.medicalrecordsCount
    ...
    filterPatient() {
      ...
      axios
        .post(`${this.filterpatientUrl}?currentPage=${this.currentPage}`, data)
        .then(response => {
          this.patients = response.data.data.patients
          this.loading = false
          let patients = this.patients
