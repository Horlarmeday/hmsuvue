            ...
            <div class="kt-widget24">
              <div class="kt-widget24__details">
                <div class="kt-widget24__info">
                  ...
                  <span class="kt-widget24__desc">
                    Total number of pharamcy store personnel
                  </span>
                </div>
          ...
          <div class="kt-portlet__body ">
            ...
            <div class="dt-responsive table-responsive">
              <table class="table table-striped table-bordered nowrap">
                ...
                <tbody v-for="(request, index) in requests" :key="request._id">
                  <tr v-if="request.status == 'pending'">
                    ...
                    <td>
                      <button
                        @click="takeAction(request, 'approve')"
                      ...
                      <button
                        @click="takeAction(request, 'decline')"
...
export default {
  ...
  data() {
    return {
      ...
      takeactionUrl: '/pharmacy/approve/request',
      landingPageUrl: '/dashboard/pharmacy/store',
  ...
  methods: {
    ...
    dashboard() {
      axios
        ...
        .then(response => {
          ...
          this.pharmacystoreCount = response.data.data.pharmacystoreCount
    ...
    takeAction(request, value) {
      const data = {
        requestId: request._id,
        action: value
      }
      axios
        .post(this.takeactionUrl, data)
        .then(response => {
