      ...
      <div class="kt-portlet__head kt-portlet__head--lg">
        <div class="kt-portlet__head-label">
          ...
          <h3 class="kt-portlet__head-title">
            Create Insurance
            <small>Create a new insurance record</small>
          </h3>
        </div>
      </div>
          ...
          <div class="col-xl-12">
            <div class="form-group">
              ...
              <span class="form-text text-muted"
                >Please enter insurance name.</span
              >
            </div>
          </div>
          <div class="col-xl-12">
          ...
          <table class="table table-striped table-bordered nowrap">
            ...
            <tbody>
              ...
              <tr v-for="(insurance, index) in insurances" :key="insurance._id">
                ...
                <td>{{ insurance.createdAt | moment('DD/MM/YYYY') }}</td>
                <td>
                  <!-- <button
                    v-if="!deletedata && insurance._id !== currentInsurance._id"
...
export default {
  ...
  methods: {
      ...
      axios
        ...
        .then(response => {
          ...
          for (let i = 0; i < insurances.length; i++) {
            insurances[i].url = '/hmo/' + insurances[i]._id
          }
        })
        .catch(error => {
          this.handleError(error)
    ...
    //   axios
    //     .delete(this.imagingUrl, { data: { ibsuranceId: insurance._id } })
    //     .then(response => {
