      ...
      >
        ...
        >
          ...
          <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
            ...
            <AppointmentParamsForm title="Patients" />
          </div>
          <!-- <Footer /> -->
        </div>
      </div>
...
import AppointmentParamsForm from '@/components/appointments/AppointmentParamsForm.vue'
export default {
  name: 'createappointmentparams',
  components: {
    Sidebar,
    Header,
    Subheader,
    // Footer,
    AppointmentParamsForm
  }
}
</script>
