      ...
      >
        ...
        >
          ...
          <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
            ...
            <DependantPageContent title="Consultations" />
          </div>
          <!-- <Footer /> -->
        </div>
      </div>
...
import DependantPageContent from '@/components/consultations/DependantPage.vue'
export default {
  name: 'dependantConsultation',
  components: {
    Sidebar,
    Header,
    Subheader,
    // Footer,
    DependantPageContent
  }
}
</script>
