      ...
      >
        ...
        >
          ...
          <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
            ...
            <ChemicalPathologyResult title="Chemical Pathology Result" />
          </div>
          <!-- <Footer /> -->
        </div>
      </div>
...
import ChemicalPathologyResult from '@/components/laboratory/ChemicalPathologyResult.vue'
export default {
