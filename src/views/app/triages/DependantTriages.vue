      ...
      >
        ...
        >
          ...
          <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
            ...
            <DependantTriageTable title="Triages" />
          </div>
          <!-- <Footer /> -->
        </div>
      </div>
...
import DependantTriageTable from '@/components/triages/DependantTriageTable.vue'
export default {
  name: 'dependanttriage',
  components: {
    Sidebar,
    Header,
    Subheader,
    // Footer,
    DependantTriageTable
  }
}
</script>
