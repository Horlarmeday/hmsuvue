    ...
    >
      ...
      >
        <div
          ...
          style="height: 871px;overflow: hidden;"
        >
          <ul class="kt-menu__nav ">
            ...
            >
              <b-link v-b-toggle.accordion-1 class="m-1 kt-menu__link">
                ...
                ><span class="kt-menu__link-text">Patients</span>
              </b-link>
              <b-collapse id="accordion-1" accordion="my-accordion">
                <ul style="background:#000628;" class="kt-menu__subnav">
                  <li
                    v-if="
                      user.role == 'Super Admin' ||
                        user.role == 'Medical Records' ||
            ...
            <li
              v-if="user.role == 'Nurse' || user.role == 'Super Admin'"
              class="kt-menu__item"
            >
              <b-link v-b-toggle.accordion-3 class="m-1 kt-menu__link">
                ...
                ><span class="kt-menu__link-text">Triages</span>
              </b-link>
            ...
            >
              <b-link v-b-toggle.accordion-4 class="m-1 kt-menu__link">
                ...
                ><span class="kt-menu__link-text">Nurse Utilities</span>
              </b-link>
            ...
            >
              <b-link v-b-toggle.accordion-5 class="m-1 kt-menu__link">
                ...
                ><span class="kt-menu__link-text">Consultation</span>
              </b-link>
            ...
            <li
              v-if="user.role == 'Super Admin' || user.role == 'Pharmacy'"
              class="kt-menu__item"
            >
              <b-link v-b-toggle.accordion-7 class="m-1 kt-menu__link">
                ...
                ><span class="kt-menu__link-text">Pharmacy</span>
              </b-link>
            ...
            <li
              v-if="user.role == 'Super Admin' || user.role == 'Laboratory'"
              class="kt-menu__item"
            >
              <b-link v-b-toggle.accordion-8 class="m-1 kt-menu__link">
                ...
                ><span class="kt-menu__link-text">Laboratory</span>
              </b-link>
            ...
            <li
              v-if="user.role == 'Super Admin' || user.role == 'Pharmacy Store'"
              class="kt-menu__item"
            >
              <b-link v-b-toggle.accordion-9 class="m-1 kt-menu__link">
                ...
                ><span class="kt-menu__link-text">Pharmacy Store</span>
              </b-link>
              <b-collapse id="accordion-9" accordion="my-accordion">
                <ul class="kt-menu__subnav">
                  <li
                    class="kt-menu__item kt-menu__item--submenu"
                    data-ktmenu-submenu-toggle="hover"
            ...
            <li
              v-if="user.role == 'Super Admin' || user.role == 'Lab Store'"
              class="kt-menu__item"
            >
              <b-link v-b-toggle.accordion-10 class="m-1 kt-menu__link">
                ...
                ><span class="kt-menu__link-text">Lab Store</span>
              </b-link>
              <b-collapse id="accordion-10" accordion="my-accordion">
                <ul class="kt-menu__subnav">
                  <li
                    class="kt-menu__item kt-menu__item--submenu"
                    data-ktmenu-submenu-toggle="hover"
            ...
            <li
              v-if="
                user.role == 'Super Admin' || user.role == 'Medical Imaging'
              "
              class="kt-menu__item"
            >
              <b-link v-b-toggle.accordion-11 class="m-1 kt-menu__link">
                ...
                ><span class="kt-menu__link-text">Imaging</span>
              </b-link>
              <b-collapse id="accordion-11" accordion="my-accordion">
                <ul class="kt-menu__subnav">
                  <li
                    class="kt-menu__item kt-menu__item--submenu"
                    data-ktmenu-submenu-toggle="hover"
            ...
            <li v-if="user.role == 'Super Admin'" class="kt-menu__item">
              ...
              <b-collapse id="accordion-12" accordion="my-accordion">
                <ul class="kt-menu__subnav">
                  <li
                    class="kt-menu__item kt-menu__item--submenu"
                    data-ktmenu-submenu-toggle="hover"
                  ...
                  >
                    <router-link
                      to="/create-staff-chatkit-account"
                      class="kt-menu__link"
                      style="padding-left: 40px;height: 40px;color:#9899ac;"
                      ><i
                        style="flex: 0 0 15px"
            ...
            <li
              v-if="user.role == 'Super Admin' || user.role == 'Doctor'"
              class="kt-menu__item"
            >
              <b-link v-b-toggle.accordion-16 class="m-1 kt-menu__link">
                ...
                ><span class="kt-menu__link-text">Theater</span>
              </b-link>
              <b-collapse id="accordion-16" accordion="my-accordion">
                <ul class="kt-menu__subnav">
                  <li
                    class="kt-menu__item kt-menu__item--submenu"
                    data-ktmenu-submenu-toggle="hover"
            ...
            >
              ...
              <b-collapse id="accordion-17" accordion="my-accordion">
                <ul class="kt-menu__subnav">
                  <li
                    class="kt-menu__item kt-menu__item--submenu"
                    data-ktmenu-submenu-toggle="hover"
            ...
            <li
              ...
              class="kt-menu__item"
            >
              <b-link v-b-toggle.accordion-22 class="m-1 kt-menu__link">
                <span class="kt-menu__link-icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink"
              ...
              <b-collapse id="accordion-22" accordion="my-accordion">
                <ul class="kt-menu__subnav">
                  <li
                    class="kt-menu__item kt-menu__item--submenu"
                    data-ktmenu-submenu-toggle="hover"
            ...
            <li class="kt-menu__section ">
              <h4 class="kt-menu__section-text">Exit</h4>
              <i class="kt-menu__section-icon flaticon-more-v2"></i>
            </li>
            <li
              class="kt-menu__item  kt-menu__item--active"
            ...
            >
              <router-link to="#" class="kt-menu__link "
                ...
                ><span class="kt-menu__link-text">Logout</span></router-link
              >
            </li>
          </ul>
        </div>
